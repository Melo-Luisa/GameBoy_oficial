...
class Juiz{
    ...
    private:
        ...
        Ball bolinha ; 
    public:
        Juiz(int x, int y, int vx, int vy, int circleRadius, int countBlack, int countWhite):bolinha(x,y,vx,vy,circleRadius){}

        // void draw_Ball(TFT_eSprite &ball); // desenha bola
        // void placar( placar, int countBlack, int countWhite, ball); // desenha placar
...
// void Juiz::placar(placar, int countBlack, int countWhite, ball){
