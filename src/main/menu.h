...
class Menu{
    ...
    public:
        Menu(int geral, int games, int settings, int credits, int geral_index, int games_index, int setting_index): joy(32,33){}

        void init();/*função já existente pra desenhar a inicialização*/

        void drawMenuInicial();/*desenha o menu inicial, com as opções de games, créditos e settings*/
        ...
        void trackPosition(int geral,int geral_index, int games, int games_index, int settings, int settings_index, int credits);
